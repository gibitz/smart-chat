...
import { MessageSquare, AtSign, User, Mail, Lock, Eye, EyeOff, Loader2 } from "lucide-react";
...
const SignUpPage = () => {
	...
	return (
		<div className="min-h-screen grid bg-base-200 lg:grid-cols-2">
			{/* left side */}
			<div className="flex flex-col justify-center items-center">
				<div className="w-full max-w-md space-y-8">
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<button type="submit" className="btn btn-primary rounded-lg w-full" disabled={isSigningUp}>
							{isSigningUp ? (
								<>
