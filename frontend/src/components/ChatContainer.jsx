				...
				{messages.map((message, i) => (
					<div>
						...
						>
							...
							<div className={`chat-bubble rounded-lg ${message.senderId === authUser._id ? "bg-primary text-primary-content" : "bg-base-200 text-base-content"} break-words mx-w-sm sm:max-w-md`}>
